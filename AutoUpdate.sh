...
`echo -e "\033[32m 2. (推荐)更新 5.15 系固件 \033[0m"`
...
`echo -e "\033[32m 6. 更新至 2022.09.16 编译的 R22.9.1  5.10.142 \033[0m"`

`echo -e "\033[32m 7. 更新至 2022.10.23 编译的 R22.10.10 5.10.148 \033[0m"`

`echo -e "\033[32m 8. 更新至 2022.11.06 编译的 R22.11.11 5.10.153 \033[0m"`
...
8)
echo
echo -e "【2022.11.06 更新日志】"
echo -e "1.同步编译源码库到固件发布当天"
echo -e "2.固件版本 R22.11.11 内核更新 5.10.153"
cd /mnt/mmcblk2p4
rm -rf *.sh Phicomm-N1_*
url=https://github.com/hm-Private/OpenWrt/releases/download/v0.0.02/Phicomm-N1_OP-R22.11.11_5.10.153.tar.xz
if [ -f "/etc/update.sh" ]; then
cp -r /etc/update.sh /mnt/mmcblk2p4                        #升级脚本 存在 则复制到mmcblk2p4录目
else                                                       #升级脚本 不存在 则下载到mmcblk2p4目录
cd /mnt/mmcblk2p4
...
`echo -e "\033[32m 4. 更新至 2022.07.07 编译的 R22.7.7  5.15.52 \033[0m"`

`echo -e "\033[32m 5. 更新至 2022.08.05 编译的 R22.8.2  5.15.59 \033[0m"`

`echo -e "\033[32m 6. 更新至 2022.09.16 编译的 R22.9.1  5.15.67 \033[0m"`

`echo -e "\033[32m 7. 更新至 2022.10.23 编译的 R22.10.10 5.15.74 \033[0m"`

`echo -e "\033[32m 8. 更新至 2022.11.06 编译的 R22.11.11 5.15.77 \033[0m"`
...
echo -e "【2022.11.06 更新日志】"
echo -e "1.同步编译源码库到固件发布当天"
echo -e "2.固件版本 R22.11.11 内核更新 5.15.77"
cd /mnt/mmcblk2p4
rm -rf *.sh Phicomm-N1_*
url=https://github.com/hm-Private/OpenWrt/releases/download/v0.0.0.1/Phicomm-N1_OP-R22.11.11_5.15.77.tar.xz
if [ -f "/etc/update.sh" ]; then
cp -r /etc/update.sh /mnt/mmcblk2p4                        #升级脚本 存在 则复制到mmcblk2p4录目
else                                                       #升级脚本 不存在 则下载到mmcblk2p4目录
cd /mnt/mmcblk2p4
